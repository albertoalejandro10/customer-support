...
const get_dataFromURL = () => {
	...
	printHeader(data)
	post_getListReconciled(data)
}

const post_getListReconciled = data => {
	const url_postListReconciled = process.env.Solu_externo + '/bancosyvalores/resumenbancario/listar_conciliaciones'
	fetch( url_postListReconciled , {
		method: 'POST',
...
const printTable = data => {
  ...
  console.log(data)
    ...
    const row = document.createElement('tr')
		...
		createAndAppendTd(row, consiliado)
